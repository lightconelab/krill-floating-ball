...
| 应用图标 | 菜单栏图标 | 菜单栏功能 | 悬浮球 |
| --- | --- | --- | --- |
| <img src="docs/images/app-icon.png" width="140" alt="应用图标"> | <img src="docs/images/menubar-icon.png" width="180" alt="菜单栏图标"> | <img src="docs/images/menubar-menu.png" width="240" alt="菜单栏功能"> | <img src="docs/images/floating-ball.png" width="140" alt="悬浮球"> |
...
2. 解压 `Krill-Floating-Ball-v0.2.0-macOS-arm64.zip`。
