...
| 菜单栏图标 | 菜单栏功能选项 | 悬浮球 |
| --- | --- | --- |
| <img src="docs/images/menubar-icon.png" width="96" alt="菜单栏图标"> | <img src="docs/images/menubar-menu.png" width="260" alt="菜单栏功能选项"> | <img src="docs/images/floating-ball.png" width="120" alt="悬浮球"> |

| 悬浮球展开栏 | 悬浮整体效果 |
| --- | --- |
| <img src="docs/images/expanded-panel.png" width="420" alt="悬浮球展开栏"> | <img src="docs/images/floating-overview.png" width="520" alt="悬浮整体效果"> |
...
- 鼠标悬浮时展示今日统计、钱包余额、刷新时间和所有生效套餐，并可与 Krill 个人中心数据对照。
...
2. 解压 `Krill-Floating-Ball-v0.2.1-macOS-arm64.zip`。
