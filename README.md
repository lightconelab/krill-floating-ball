...
| 贴边剩余额度悬浮条（垂直） | 贴边剩余额度悬浮条（水平） |
| --- | --- |
| <img src="docs/images/edge-progress-vertical.png" width="420" alt="贴边剩余额度悬浮条整体效果--垂直"> | <img src="docs/images/edge-progress-horizontal.png" width="420" alt="贴边剩余额度悬浮条整体效果--水平"> |
...
2. 解压 `Krill-Floating-Ball-v0.2.3-macOS-arm64.zip`。
