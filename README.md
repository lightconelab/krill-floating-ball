...
- 支持手动刷新、开机启动、余额阈值设置、设置 Krill 登录账号、清除登录信息、隐藏/显示悬浮球和退出应用。
...
余额模式没有固定总额度分母，因此不展示液体百分比，仅按余额区间显示状态颜色。余额区间可从菜单栏调整。
...
5. 在菜单栏中手动刷新、调整自动刷新间隔、调整余额阈值、开启或关闭开机启动、开启或关闭贴边进度条、清除登录信息或退出应用。
